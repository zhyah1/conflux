      ...
      <main className="flex-1">
        ...
        <section className="relative h-screen min-h-[700px] flex items-center justify-center text-center overflow-hidden">
          <Image
            ...
            fill
            className="object-cover -z-20 brightness-[0.35]"
          ...
          {/* Content */}
          <div className="container max-w-4xl px-4 text-white relative z-10">
            ...
            <p className="mt-4 text-lg md:text-xl text-white/90 drop-shadow-xl max-w-3xl mx-auto">
